...
function DialogPortal({
  ...
  // FIX: default ke #modal-portal-root di dalam .content-area (lihat App.tsx &
  // ModalPortalContext), bukan document.body, supaya modal terbatas di area
  // content dan tidak menutupi sidebar/header. Fallback ke document.body kalau
  // context tidak tersedia (misal di halaman Login) atau container belum siap.
