    ...
    <Dialog open={!!selectedAreaManager} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-6xl w-full max-h-[90vh] overflow-y-auto p-0 border-none shadow-2xl">
        <DialogHeader className="sr-only">
          ...
          <DialogDescription>
            Performance analytics, team tracking, and activity logs for Area Manager {selectedAreaManager.name}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="p-6 space-y-6 text-gray-900">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-center justify-between shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-blue-900">
                Performance Data for: <span className="font-bold underline">{selectedPeriod}</span>
              </span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-8 gap-4">
            <Card className="border-2 border-purple-100 hover:border-purple-500 transition-colors bg-gradient-to-br from-purple-50 to-white shadow-sm">
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="h-10 w-10 rounded-xl bg-purple-600 flex items-center justify-center shadow-lg shadow-purple-600/20">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-gray-900 flex items-center gap-3">
              ...
              Sales Managers & Teams ({selectedAreaManager.managers.length})
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {selectedAreaManager.managers.map((manager) => (
                <Card key={manager.id} className="border border-blue-100 hover:border-blue-400 transition-all bg-white shadow-sm hover:shadow-md group">
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-3">
                      <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center text-white font-bold text-lg flex-shrink-0 shadow-lg group-hover:scale-105 transition-transform">
                        {manager.avatar}
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200">
                            {manager.performance.toFixed(0)}%
                          </Badge>
                        </div>
                        <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">{manager.position}</p>
                        ...
                        <div className="mt-4">
                          <div className="flex items-center justify-between mb-1.5">
                            <span className="text-[10px] font-bold text-blue-600 uppercase tracking-wider">Overall Performance</span>
                            <span className="text-[10px] text-gray-500 font-medium">{manager.totalDeals} Deals</span>
                          </div>
          ...
          <Card className="border-none bg-gradient-to-br from-amber-50 to-orange-50 shadow-xl overflow-hidden relative">
            ...
            <CardHeader className="bg-gradient-to-r from-amber-500 to-orange-500 text-white relative z-10">
              ...
              <p className="text-sm text-white/80 mt-1 uppercase tracking-widest font-bold text-[10px]">INTERNAL TEAM LOG</p>
            </CardHeader>
              ...
              <div className="space-y-3">
                {notes.length === 0 ? (
                  <div className="text-center py-12 text-gray-400 bg-white/50 rounded-2xl border-2 border-dashed border-amber-200">
                    ...
                    <p className="text-sm font-bold uppercase tracking-wider">No active logs</p>
                  </div>
                ) : (
                  notes.map((note) => (
                    <div
